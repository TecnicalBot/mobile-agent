...
export function createExternalEditFileTool({
  onRecord,
  session,
  ...
  return tool({
    description:
      "Apply targeted text edits to a file inside the granted external folder. Each edit must be unique in the file; read the file first and include enough surrounding text.",
